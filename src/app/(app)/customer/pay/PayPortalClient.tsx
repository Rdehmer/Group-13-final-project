...
export function PayPortalClient({ initialStripeConfig }: { initialStripeConfig: StripePortalConfig }) {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title="Payments"
        description={`${customerName} · Secure Stripe checkout for EquipmentIQ`}
        actions={
          <button
            type="button"
      ...
      {feeStandingMessage ? (
        ...
        >
          ...
          <p className="mt-1 opacity-70">
            Monthly contract fees appear below as open invoices when generated by EquipmentIQ.
            ...
            {stripeSession ? (
              ...
              <>
                ...
                <p className="text-center text-xs leading-relaxed opacity-60">
                  Card and bank details are entered on Stripe&apos;s secure form and are never stored by
                  EquipmentIQ. Minimum charge $0.50.
                </p>
              </>
            )}
          </div>
