...
export function CustomerWelcomeSplash({ exiting = false, displayName }: Props) {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-busy={!exiting}
      aria-label="Loading your customer portal"
    >
      <div className="customer-welcome-content flex w-full max-w-md flex-col items-center text-center">
        ...
        <p className="customer-welcome-subtitle mt-2 text-sm opacity-80 sm:text-base">
