...
export const GL_POSTING_PURPOSES: { purpose: string; label: string; description: string }[] = [
  ...
  { purpose: "cogs_labor", label: "COGS — Labor", description: "Labor cost of services" },
  { purpose: "cogs_parts", label: "COGS — Parts", description: "Parts cost of services" },
...
const SEED_ACCOUNTS: Omit<GlAccount, "id" | "created_at" | "updated_at">[] = [
  ...
  {
    account_code: "5000",
    account_name: "Cost of Services — Labor",
    account_type: "expense",
    normal_balance: "debit",
    description: "Labor cost matched to jobs",
    is_active: true,
    is_system: true,
    sort_order: 100,
  },
  {
    account_code: "5100",
    account_name: "Cost of Services — Parts",
    account_type: "expense",
    normal_balance: "debit",
    description: "Parts cost matched to jobs",
    is_active: true,
    is_system: true,
    sort_order: 110,
  },
